...
function viewOriginalImageGallery(e) {e.preventDefault()
    ...
    if (refs.lightboxModal.classList.contains("is-open")) {
        return refs.lightboxModal.classList.remove("is-open"),
         refs.imgContentLightboxModal.removeAttribute('src'),
            refs.imgContentLightboxModal.removeAttribute('alt'),console.log( refs.imgContentLightboxModal.getAttribute('src'));
